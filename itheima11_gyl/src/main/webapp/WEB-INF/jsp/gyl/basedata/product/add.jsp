...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/images/title_arrow.gif"/> 商品
        </div>
...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="productAction_addProduct.action">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td>商品名称</td>
                        <td><s:textfield name="spmc" cssClass="InputStyle"></s:textfield></td>
                    </tr>
                    <tr><td>商品编码</td>
                        <td><s:textarea name="spbm" cssClass="InputStyle"></s:textarea></td>
                    </tr>
                    <tr><td>商品型号</td>
