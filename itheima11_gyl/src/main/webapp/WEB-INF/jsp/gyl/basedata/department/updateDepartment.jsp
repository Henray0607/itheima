...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="departmentAction_updateDepartment.action?did=%{#department.did}">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td>部门名称</td>
                        <td><s:textfield name="name" value="%{#department.name}" cssClass="InputStyle">
                        			
                        </s:textfield>
						</td>
                    </tr>
                    <tr><td>部门描述</td>
                        <td><s:textarea name="description" value="%{#department.description}" cssClass="InputStyle"></s:textarea></td>
                    </tr>
                </table>
            </div>
        </div>
