package com.isoftstone.gyl.domain.business.xsgl;
...
public class Xsddzhub implements Serializable {
	...
	private String state = "2";// 状态   "1"表示已完成   "2"表示未完成
	private String lydjh;// 来源单据号  销售订单有可能来自销售预订单,这个时候，该值为销售预订单的单据号  如果没有销售预订单，则该值为null
	/**
	 * 如果是1，说明该单据是退货单，子表中的所有的商品都是退货的商品   红字订单(正好和出库的方向是相反的)
	 */
	private String thbz = "2";// 退货标志 1 代表退货 2代表不退货
	...
	private Float zdjshj = 0.0F;// 整单价税合计
	private Float sxkje = 0.0F;// 收现款金额
